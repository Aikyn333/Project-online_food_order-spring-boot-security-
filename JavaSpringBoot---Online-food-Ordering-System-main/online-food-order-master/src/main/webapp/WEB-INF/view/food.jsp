                   ...
                   <div class="card-header text-center">
                    ...
                    <div class="text-left ml-3 mt-3"><h2>Description :</h2></div>
                        ...
                        <div class="card-footer text-center">
                                 <p style="font-size:35px"><span style="font-size:35px;"><b>Price :</b></span><span class="ml-2"><b>KZT&nbsp;<%=new Helper().getFoodSellingPrice(fod.getPrice(), fod.getDiscount()) %>/-</b></span>
                                 <span class="ml-2" style="font-size:30px;color:red"><s>KZT&nbsp;<%=fod.getPrice()%></s></span>
